...
public class AdvancedWifiSettings extends SettingsPreferenceFragment
    ...
    private SwitchPreference enableHs2Rel1;
    ...
    private ContentObserver mPasspointObserver = new ContentObserver(new Handler()) {
        ...
        public void onChange(boolean selfChange) {
            if (enableHs2Rel1 != null) {
                enableHs2Rel1.setChecked(Settings.Global.getInt(getContentResolver(),
    ...
    private void initPreferences() {
        ...
        enableHs2Rel1 = (SwitchPreference) findPreference(KEY_ENABLE_HS2_REL1);
        enableHs2Rel1.setEnabled(mWifiManager.isWifiEnabled());
        if (enableHs2Rel1 != null && getResources().getBoolean(
            ...
            getPreferenceScreen().removePreference(enableHs2Rel1);
        }
